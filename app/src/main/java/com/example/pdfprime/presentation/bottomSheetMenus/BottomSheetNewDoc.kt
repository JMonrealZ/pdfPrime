...
class BottomSheetNewDoc(
//    private val listOptions : ArrayList<BottomSheetOption>,
//    private val newDocInterface: NewDocInterface
) : BottomSheetDialogFragment(), NewDocInterface{
